...
Deepening in Python, preparing for AWS Solutions Architect certification.
Former lecturer at Kyiv Polytechnic (3 course streams, 200+ students).

## 🚀 My Projects

- **[etymap.wiki](https://etymap.wiki)** — Interactive cognate word map across languages (GoLang · SQLite · LiteStream · fly.io)
...
**Frontend:** React, TypeScript, React Native, TanStack Query, Expo, GraphQL (Apollo Federation), TailwindCSS, D3.js  
**Backend:** Node.js, NestJS, Hono, Fastify, Python, FastAPI, Go (gRPC), Kafka  
